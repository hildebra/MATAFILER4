...
This documentation set was refreshed against `MATAF4.pl` version `4.04`. For reproducible analyses, record the MATAFILER4 git commit, mapping file, `config.txt`, GTDB/GTDB-Tk versions and functional database versions used for each run.
