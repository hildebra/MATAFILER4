...
| `buildTree5.pl` | `5.37` | Phylogenetic tree construction and related MSA/population-genetic analyses. |
...
Phylogenetic tree construction and related MSA/population-genetic analyses. The source reports version `5.37`.
...
| `-relativeNTFraction` | float | `0.2` direct; `0.02` strain workflow | stable | Minimum informative nucleotide content as a fraction of the sample Q90. This explicit name replaces the retired ambiguous `-NTfilt` switch. |
