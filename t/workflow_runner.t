...
like($mataf4,
	qr/read_sample_completion\(.*?if \(\$closedSample\).*?Sample already complete; no jobs submitted.*?if \(-e \$completionSentinel\).*?invalidate_sample_completion\(\$curOutDir, \$SmplName\)/s,
...
like($mataf4, qr/#4\.11:.*?loopTillComplete.*?#4\.12:.*?#4\.13:.*?#4\.14:.*?#4\.15:.*?#4\.16:.*?#4\.21:.*?#4\.22:.*?#4\.23:.*?#4\.24:.*?#4\.25:.*?#4\.26:.*?#4\.27:.*?#4\.28:.*?#4\.29:.*?#4\.30:.*?#4\.31:.*?#4\.32:.*?#4\.33:.*?#4\.34:.*?#4\.35:.*?#4\.36:.*?#4\.37:.*?#4\.38:.*?#4\.39:.*?#4\.40:.*?#4\.41:.*?#4\.42:.*?#4\.43:.*?my \$MATFILER_ver = 4\.43/s,
	'MATAFILER history retains loop, scheduler, and resilience changes through version 4.43');
