...
like($mataf4,
	...
	'lightweight UZ setup refreshes its audit script and runs locally while data-processing commands remain scheduled');
like($mataf4,
	qr/my \@mapFields = qw\(\s*SmplID dir rddir prefix/s,
	'completion sentinels are invalidated when the map input directory or prefix changes');
unlike($mataf4,
